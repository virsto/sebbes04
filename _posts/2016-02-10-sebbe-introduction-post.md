...
<!--
Jag gillar att lyssna på musik och har min egen spellista på Spotify, som jag uppdaterar jämt.   Jag lånar mammas och pappas telefoner för att lyssna på musiken. Jag gillar simning, matte och engelska. Minst av allt tycker jag om spenat och att mamma "bestämmer" för mycket. Here is a link to Mathematica Alpha where one can learn how to solve mathematical problems.
-->
...
<!--
Jag gillar böcker jättemycket. Just nu läser jag Tsatsiki-serien och har även sett filmerna. Jag har också läst t.ex alla böckerna om LasseMajas detektivbyrå (21st), alla böckerna i serien "Jakten om Jack" mm mm. Jag gillar experimentböcker och läser serietidningar - helst mammas och pappas gamla om Kalle Anka.
-->
...
<!--
Två av mina absoluta favoritpersoner i hela världen är min mormor och morfar. Ibland åker jag hem till dem efter skolan. Det är så mysigt där och de pysslar om mig hela tiden. Jag får alltid spela Minecraft, äta middag framför tv'n och äta av morfars favoritgodis, som är Riesen-kola.
-->



<!--  The following is the general for aligning images horizontally
...
<p style="float: left; font-size: 9pt; text-align: center; width: 30%; 
   margin-right: 1%; margin-bottom: 0.5em;"><img src="imageLocation" style="width: 100%">Caption</p>
   
Replace the imageLocation with the URL or foler of the image, and the Caption with any text 
you want. If the text is too long to fit on one line, it'll wrap around.

Repeat that code chunk for each "box" — the image plus its caption— without skipping lines 
between the chunks.
...
<!-- for two images aligned horizontally -->
<!--
<p style="float: left; font-size: 9pt; text-align: center; width: 25%; margin-right: 1%; margin-bottom: 0.5em;">  
<img src="assets/images/1000.jpg" class = "img-responsive" style="width:100%">Happy Kittens-1</p>
<p style="float: left; font-size: 9pt; text-align: center; width: 25%; margin-right: 1%; margin-bottom: 0.5em;">  
<img src="assets/images/1000.jpg" class = "img-responsive" style="width:100%">Happy Kittens-2</p>
<!-- <p style="clear: both;"> -->
